 ...
 */
public class FlowChartRenderMacroV4 implements Macro {

   private final PlantUmlRenderMacroV4 plantUmlRenderMacroV4;

   public FlowChartRenderMacroV4(WritableDownloadResourceManager writeableDownloadResourceManager, PageManager pageManager,
      ...
      plantUmlRenderMacroV4 =
            new PlantUmlRenderMacroV4(writeableDownloadResourceManager, pageManager, spaceManager, settingsManager,
      ...
      try {
         return new AbstractFlowChartMacroImpl() {
            ...
            protected String executePlantUmlMacro(Map<String, String> params, String dotString, RenderContext context)
               ...
               return plantUmlRenderMacroV4.execute(params, dotString, context);
            }
   ...
   public BodyType getBodyType() {
      return plantUmlRenderMacroV4.getBodyType();
   }

   public OutputType getOutputType() {
      return plantUmlRenderMacroV4.getOutputType();
   }
