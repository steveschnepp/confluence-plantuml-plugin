 ...
 */
public class PlantUmlRenderMacroV4 extends PlantUmlMacro implements Macro {

   public PlantUmlRenderMacroV4(WritableDownloadResourceManager writeableDownloadResourceManager, PageManager pageManager,
      ...
      super(writeableDownloadResourceManager, pageManager, spaceManager, settingsManager, pluginAccessor,
            shortcutLinksManager, configurationManager, i18NBeanFactory);
   }
   ...
   public String execute(Map<String, String> params, String bodyAsHtml, ConversionContext context)
      ...
      try {
         final Document doc = Jsoup.parseBodyFragment(bodyAsHtml);
         doc.outputSettings(new Document.OutputSettings().prettyPrint(false));
         doc.select("br").append("\\n");
         doc.select("p").prepend("\\n\\n");
         final String bodyAsText = doc.body().text().replaceAll("\\\\n", "\n");

         return executeInternal(params, bodyAsText, context.getPageContext());
