 ...
 */
public class DatabaseStructureMacro extends BaseMacro {
   ...
   public DatabaseStructureMacro(WritableDownloadResourceManager writeableDownloadResourceManager, PageManager pageManager,
